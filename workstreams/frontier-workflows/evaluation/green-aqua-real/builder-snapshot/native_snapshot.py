...
def adapt_scene(context, *, flush=False):
    ...
    if flush:
        ...
        if previous_hash and previous_hash != state_hash:
            ...
            log.append({"revision": revision, "source": "native_user_transform",
...
def capture_scene(context, directory):
    import bpy
    global SUPPRESS
...
def validate_snapshot(value):
    exact(value, ("schemaVersion", "sceneId", "baseRevision", "stateHash", "recipe", "objects", "protectedIds", "sourceRun", "blendPath", "blendHash", "capturedAt"), path="native snapshot")
